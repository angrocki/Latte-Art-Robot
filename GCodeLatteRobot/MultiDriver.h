...
#define MAX_MOTORS 5    // a reasonable but arbitrary limit
...
public:
     ...
     */
    void move(long steps1, long steps2, long steps3, long steps4, long steps5=0);
    void rotate(int deg1, int deg2, int deg3, int deg4, int deg5=0){
        rotate((long)deg1, (long)deg2, (long)deg3,(long)deg4,(long)deg5);
    };
    void rotate(long deg1, long deg2, long deg3,long deg4,long deg5=0);
    void rotate(double deg1, double deg2, double deg3,double deg4=0,double deg5=0);

    /*
     * Motor movement with external control of timing
     */
    virtual void startMove(long steps1, long steps2, long steps3,long steps4,long steps5=0);
    void startRotate(int deg1, int deg2, int deg3,int deg4,int deg5=0){
        startRotate((long)deg1, (long)deg2, (long)deg3,(long)deg4,(long)deg5);
    };
    void startRotate(long deg1, long deg2, long deg3,long deg4,long deg5=0);
    void startRotate(double deg1, double deg2, double deg3,double deg4=0,double deg5=0);
    /*
