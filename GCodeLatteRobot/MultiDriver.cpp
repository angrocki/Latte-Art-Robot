 ...
 */
void MultiDriver::startMove(long steps1, long steps2, long steps3, long steps4, long steps5){
    long steps[5] = {steps1, steps2, steps3, steps4, steps5};
    /*
 ...
 */
void MultiDriver::move(long steps1, long steps2, long steps3, long steps4, long steps5){
    startMove(steps1, steps2, steps3, steps4, steps5);
    while (!ready){
        nextAction();
    }
}
...
void MultiDriver::rotate(long deg1, long deg2, long deg3, long deg4, long deg5){
    move(CALC_STEPS(0, deg1), CALC_STEPS(1, deg2), CALC_STEPS(2, deg3), CALC_STEPS(3, deg4), CALC_STEPS(4, deg5));
}

void MultiDriver::rotate(double deg1, double deg2, double deg3, double deg4, double deg5){
    move(CALC_STEPS(0, deg1), CALC_STEPS(1, deg2), CALC_STEPS(2, deg3), CALC_STEPS(3, deg4), CALC_STEPS(4, deg5));
}

void MultiDriver::startRotate(long deg1, long deg2, long deg3, long deg4, long deg5){
    startMove(CALC_STEPS(0, deg1), CALC_STEPS(1, deg2), CALC_STEPS(2, deg3), CALC_STEPS(3, deg4), CALC_STEPS(4, deg5));
}

void MultiDriver::startRotate(double deg1, double deg2, double deg3, double deg4, double deg5){
    startMove(CALC_STEPS(0, deg1), CALC_STEPS(1, deg2), CALC_STEPS(2, deg3), CALC_STEPS(3, deg4), CALC_STEPS(4, deg5));
}
